...
export function ChatRoom({ girlId, onBack }: ChatRoomProps) {
  ...
  return (
    ...
    >
      <div className="z-10 border-b border-black/5 bg-white/70 px-5 pb-4 pt-5 backdrop-blur-xl shadow-sm">
        ...
        <div className="mt-4 h-1.5 overflow-hidden rounded-full bg-rose-100/50 shadow-inner">
          <motion.div
        ...
        {replySourceLabel ? (
          <div className="mt-3 space-y-2">
            <div className="rounded-2xl bg-slate-100/80 px-3.5 py-2.5 text-[12px] font-medium text-slate-600 shadow-sm">
              {routineStatus.description}
            </div>
            <div className="inline-flex rounded-full bg-white/80 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-wine/60 shadow-sm ring-1 ring-black/5">
              {s.replySourceLabel}{replySourceLabel}
            </div>
            {fallbackReason ? (
              <div className="rounded-2xl bg-amber-50 px-3.5 py-2.5 text-[12px] font-medium text-amber-700 shadow-sm">
